...
function About() {
    ...
    return (
        <div className="container-fluid" id="main-about">
            <div className="container">
                <h4 id="pronoun">Pronoun & Codename</h4>
                <h3 id="code-name">He/Him &#129419; LonEr/Disorn &#129419; 孤独な</h3>
                <hr id="line-sep"/>
                <div className="row row-about">
                    <div className="container col-sm-12 col-md-6 col-lg-6" id="education">
                        <p className="topic-about">Education</p>
                    ...
                    <div className="container col-sm-12 col-md-6 col-lg-6" id="experience">
                        <p className="topic-about">Experiences</p>
                        <div className="container con-box">
                            <div className="text-box">
                                <p className="org-name">Working for Accenture Company as Junior and Senior Backend Developer</p>
                                <small className="year">August 2020 - Present</small>
                                <ul>
                                    <li>To responsible for the project Corporate Portal about transaction management within a company</li>
                                    <li>To responsible for the project Maemanee about a merchant management system integrated with shipping the third party</li>
                                    <li>Maintained and implemented a new feature on SCB Easy with the part about a loan</li>
                                    ...
                                    <li>Investigated and resolved the issue on stage and production environment for all projects</li>
                                </ul>
                                <div className="span-tag" id="span-tag-1">
                        ...
                        <div className="container con-box">
                            <div className="text-box">
                                ...
                                <ul>
                                    <li>To responsible for the project about e-commerce connecting with others platform including Lazada and Shopee</li>
                                    <li>Designed API by using DDD, CQRS, and Event driven concept</li>
                                    <li>Design database schema on Dynamo DB</li>
                                    <li>Developed the backend part with Node js, Nest js and Typescript with AWS service including Lambda, S3, API Gateway, SQS, SNS and Cognitio</li>
                        ...
                        <div className="container con-box">
                            <div className="text-box">
                                <p className="org-name">Working for Allianz Technology Company as Junior Backend Developer</p>
                                <small className="year">July 2019 - November 2019</small>
                               <ul>
                                   <li>Developed the project about chatbot marketplace using Oauth2 for authentication and Node js . In part of automation into the stages of app deployment (CI/CD process) used Jenkins and Docker on Openshift</li>
                        ...
                        <div className="container con-box">
                            <div className="text-box">
                                ...
                                <p className="org-desc">First Runner Up with Accenture Hackathon in topic about how to use technology to assist disable people who were unemployed</p>
                                <div className="span-tag" id="span-tag-1">
